              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="w-24 h-12 rounded-lg overflow-hidden border border-gray-200 relative group shrink-0">
                      <img
                  ...
                  <td className="px-6 py-4">
                    <div className="font-bold text-gray-900 whitespace-nowrap">{banner.title}</div>
                    {banner.subtitle && (
